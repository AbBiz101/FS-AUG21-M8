...
productsRouter
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, model_js_1.ProductModel.find({})];
            case 1:
                products = _a.sent();
                res.send(products);
                return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, model_js_1.ProductModel.findById(req.params.id)];
            case 1:
                product = _a.sent();
                console.log(product);
                if (!product) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                product = new model_js_1.ProductModel(req.body);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, model_js_1.ProductModel.findByIdAndUpdate(req.params.id, req.body, { new: true })];
            case 1:
                product = _a.sent();
                if (!product) {
                    res.status(404).send();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, model_js_1.ProductModel.findByIdAndDelete(req.params.id)];
            case 1:
                product = _a.sent();
                if (!product) {
                    res.status(404).send();
